...
class PayrollSystem{
    ...
    public void addEmployee(){
        ...
        if(type == 1){
            ...
            System.out.println("You want add more employees[Y/N]: ");
            ...
            System.out.println("Enter the ID: ");
            int id = in.nextInt();
            System.out.println("Enter how many hour you worked: ");
            int hour = in.nextInt();
            System.out.println("Enter the per hour rate: ");
            int rate = in.nextInt();
            PartTimeEmployee partTimeEmployee = new PartTimeEmployee(name,id,hour,rate);
...
public class Main{
    public static void main(String[] args) {
        ...
        //FullTimeEmployee emp1 = new FullTimeEmployee("Sudhakar", 19, 80000);
        //FullTimeEmployee emp2 = new FullTimeEmployee("Virat", 18, 90000);
        //FullTimeEmployee emp3 = new FullTimeEmployee("Deviliars", 17, 85000);
        //PartTimeEmployee emp4 = new PartTimeEmployee("Maxi", 32, 20, 500);
        ...
        switch (choice){
            case 1 : payroll.displayAllDetail();
                break;
